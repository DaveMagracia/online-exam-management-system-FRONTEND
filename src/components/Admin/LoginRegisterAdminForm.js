...
export default function LoginRegisterAdminForm() {
   ...
   const [isLoginBtnEnabled, setIsLoginBtnEnabled] = React.useState(true);
            ...
            .catch((err) => {
               ...
               setAttempts((prevVal) => {
                  ...
                  if (newVal > 3) {
                     ...
                     setLoginError({
                        hasError: true,
                        errorMsg: "You have attempted too many times. Try again in 60 seconds.",
                     });
            ...
            <div
               ...
               <div className={`${css.form_container} ${css.sign_in_container}`}>
                  <form action="#" className={css.formLogin} onSubmit={loginAdmin}>
                     ...
                     <button type="submit" className={css.buttons} disabled={!isLoginBtnEnabled}>
                        Sign In
                     </button>
                  </form>
               </div>
