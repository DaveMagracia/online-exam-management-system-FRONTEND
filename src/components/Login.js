                    ...
                    <form onSubmit={loginUser}>
                        ...
                        <div className="form-floating">
                            <input 
                                ...
                                type="text" 
                                className={`form-control ${emptyErrors.email_username ? 'border border-danger' : 'mb-4'}`}
                                name='email_username' 
                                onChange={handleOnChange}  
                                value={formData.email_username}/>
                            <label htmlFor="InputEmailUsername">email/username</label>
                        </div>
                        {emptyErrors.email_username && <p className='text-danger mb-4 small'>This field is required</p>}
                        ...
                        <div className="form-floating">
                            <input 
                                id="InputPassword" 
                                type="password" 
                                className={`form-control ${emptyErrors.pass ? 'border border-danger' : 'mb-4'}`}
                                name='pass' 
                                onChange={handleOnChange}  
                                value={formData.pass}/>
